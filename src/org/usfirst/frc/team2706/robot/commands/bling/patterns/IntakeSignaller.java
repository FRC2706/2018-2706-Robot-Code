...
/**
 * 
 * @author eAUE (Kyle Anderson) Pattern for showing if the cube is successfully loaded.
 */
public class IntakeSignaller extends BlingPattern {
    ...
    public boolean conditionsMet() {
        ...
        /*
         * Update the patternBeingDisplayed boolean as needed If the cubeStateWasSwitched, we make
         * it true no mater what. If not, if we were last displaying a pattern and are under 3
         * seconds in of doing so, continue to display the pattern so long as we also still have the
         * cube.
         */
        patternBeingDisplayed =
                        cubeStateSwitched || (patternBeingDisplayed && timePassed < 3 && isCubeIn);
