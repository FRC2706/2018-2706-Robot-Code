...
public class LeftStartLeftSwitch extends CommandGroup {
    ...
    public LeftStartLeftSwitch() {
        ...
        // Drive beside switch
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 142 / 12.0,
        ...
        // Drive into switch
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED, 48 / 12.0,
                        AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES,
        ...
        // Removed as untested
//         // Drive to alley
//         this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 72 / 12.0,
//         AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".driveToSwitch"), 2);
//        
//         // Turn down alley
//         this.addSequential(new RotateDriveWithGyro(90, this + ".rotateToSwitch"), 3);
//        
//         // Drive half way down alley
//         this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 48 / 12.0,
//         AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".driveToSwitch"), 2);
    }
