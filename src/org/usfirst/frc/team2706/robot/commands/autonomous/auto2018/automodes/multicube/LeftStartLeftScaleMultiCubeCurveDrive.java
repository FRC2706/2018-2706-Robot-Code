 ...
 * 
 * Curve drives to the left scale, places the cube,
...
public class LeftStartLeftScaleMultiCubeCurveDrive extends CommandGroup {
    ...
    public LeftStartLeftScaleMultiCubeCurveDrive() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED,-5.3,AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".backToScale"),3);
