 ...
 * 
 * Curve drives to the right scale, places the cube, grabs another, and places it in the right
 * switch
 */
public class RightStartRightScaleRightSwitchMultiCube extends CommandGroup {
    ...
    public RightStartRightScaleRightSwitchMultiCube() {
        ...
        this.addParallel(new SetLiftHeightBlockingAfterTime(AutoConstants.SCALE_HEIGHT, 5, 0.2,
                        1000));
        this.addSequential(new CurveDrive(2, 19, 25, 0.8, true, this + ".curveToScale"));
