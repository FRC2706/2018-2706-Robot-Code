...
public class CenterStartLeftSwitch extends CommandGroup {
    ...
    public CenterStartLeftSwitch() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED, 3, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".hitSwitch"),2);
