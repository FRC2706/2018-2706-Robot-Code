...
public class CenterStartLeftSwitch extends CommandGroup {
    ...
    public CenterStartLeftSwitch() {
        ...
        // Drive forward
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 0.8, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".awayFromWall"),1);
        
        // Turn and drive towards switch
        this.addSequential(new RotateDriveWithGyro(-50, this + ".faceSwitch"),2);
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 8.1, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".forwardToSwitch"),5);
        ...
        // Drive into switch
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED, 3.5, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".hitSwitch"),2);
