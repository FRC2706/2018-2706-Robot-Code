...
public class CenterStartRightSwitchMultiCube extends CommandGroup {
    ...
    public CenterStartRightSwitchMultiCube() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, -4, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".back"), 2);
       ...
       // this.addParallel(new IntakeCube(0.6), 2);
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST,4, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".forwardToSwitch2"), 2);
