...
public class CenterStartRightSwitchMultiCube extends CommandGroup {
    ...
    public CenterStartRightSwitchMultiCube() {
        this.addSequential(new StraightDriveWithEncoders(0.8, 1.02, 1.5, 3, this + ".awayFromWall"), 2);
        this.addSequential(new RotateDriveWithGyro(0.6, 38.5, 1.5, 3, this + ".faceSwitch"), 2);
        this.addSequential(new StraightDriveWithEncoders(0.8, 5, 3, 5, this + ".driveToSwitch"), 5);
        ...
        this.addSequential(new StraightDriveWithEncoders(0.6, 3, 3, 3, this + ".forwardToSwitch"), 2);
        ...
        this.addSequential(new StraightDriveWithEncoders(0.8, -3.3, 2, 3, this + ".back"));
        this.addSequential(new RotateDriveWithGyro(0.6, -44, 1, 3, this + ".turnToPile"), 2);
       ...
       // this.addParallel(new IntakeCube(0.6), 2);
        ...
        this.addSequential(new RotateDriveWithGyro(0.6, 44, 1, 3, this + ".turnForSecondCube"));
        this.addParallel(new SetLiftHeight(1.5));
        this.addSequential(new StraightDriveWithEncoders(0.7,3, 2, 3, this + ".forwardToSwitch2"), 2.5);
        this.addSequential(new EjectCube(0.5), 0.5);
