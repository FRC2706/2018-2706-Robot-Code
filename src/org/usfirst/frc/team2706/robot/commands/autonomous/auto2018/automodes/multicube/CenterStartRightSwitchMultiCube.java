 ...
 * 
 * Places the cube in the right switch, grabs another,
 * and places it in the right scale
 */
public class CenterStartRightSwitchMultiCube extends CommandGroup {
    ...
    public CenterStartRightSwitchMultiCube() {
        ...
        this.addSequential(new StraightDriveFromCommand(AutoConstants.SPEED_FAST, grabCommand, AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES, this + ".backFromWall"),2);
