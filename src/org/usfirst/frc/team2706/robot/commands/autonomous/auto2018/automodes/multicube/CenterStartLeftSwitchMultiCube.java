 ...
 * 
 * Places the cube in the left switch, grabs another, and places it in the left scale
 */
public class CenterStartLeftSwitchMultiCube extends CommandGroup {
    ...
    public CenterStartLeftSwitchMultiCube() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, -43.0 / 12.0,
        ...
        this.addSequential(new StraightDriveFromCommand(AutoConstants.SPEED_FAST, g,
        ...
        // Drive into switch
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED, 45 / 12.0,
                        AutoConstants.LENIENT_ERROR, AutoConstants.LENIENT_CYCLES,
