 ...
 * 
 * This mode is often used when the lift does not work.
 * This mode is also extremely consistent and never failed at competition.
 */
public class CenterStartExchangeCube extends CommandGroup {
    ...
    public CenterStartExchangeCube() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_SLOW,46 / 12.0,AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".driveToExchange"),2);
