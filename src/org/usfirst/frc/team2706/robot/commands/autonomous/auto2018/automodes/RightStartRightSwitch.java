...
public class RightStartRightSwitch extends CommandGroup {
    ...
    public RightStartRightSwitch() {
        ...
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_FAST, 135 / 12.0, AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".forwardToSwitch"), 7);
