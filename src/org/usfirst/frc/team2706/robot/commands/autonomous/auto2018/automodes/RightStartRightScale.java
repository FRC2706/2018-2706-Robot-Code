 ...
 * 
 * Curve drives to the right scale, places the cube, and drives towards the next cube
 */
public class RightStartRightScale extends CommandGroup {
    ...
    public RightStartRightScale() {
        ...
        // Back off of scale
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED, -2, 1, 2, this + ".backOffScale"));
        ...
        // Drive towards cube
        this.addSequential(new StraightDriveWithEncoders(0.75, -5, 1.0, 1, this + ".driveTowardsCube"));
    }
