...
public class RightStartRightScaleMultiCubeCurveDrive extends CommandGroup {
    ...
    public RightStartRightScaleMultiCubeCurveDrive() {
        this.addParallel(new SetLiftHeightBlocking(6.5, 5, 0.2));
        this.addSequential(new CurveDriveTwoSpeed(2,19.75,25,0.95,0.85,0.7,10, 13,true,"B"))                                   ;
        ...
        this.addParallel(new SetLiftHeightBlocking(6.5,2,0.1),4);
