 ...
 * 
 * Curve drives to the right scale, places the cube, grabs another, places it, and grabs one more
 * without placing it.
 */
public class RightStartRightScaleMultiCubeCurveDrive extends CommandGroup {
    ...
    public RightStartRightScaleMultiCubeCurveDrive() {
        ...
        this.addSequential(new RotateDriveWithGyro(0.35, -110, 2, 3,
                        this + ".turnRightTowardsSwitch2"), 2);
