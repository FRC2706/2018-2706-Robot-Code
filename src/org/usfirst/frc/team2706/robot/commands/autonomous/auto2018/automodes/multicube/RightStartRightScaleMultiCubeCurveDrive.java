 ...
 * 
 * Curve drives to the right scale, places the cube,
 * grabs another, places it, and grabs one more without placing it.
 */
public class RightStartRightScaleMultiCubeCurveDrive extends CommandGroup {
    ...
    public RightStartRightScaleMultiCubeCurveDrive() {
        ...
        this.addSequential(new CurveDriveTwoSpeed(2.5,20,25,0.95,0.9,0.7,10, 14,true, this + ".curveToScale"));
        ...
        this.addSequential(new PickupCubeAuto(0.9,0.5, 0.25), 5);
        ...
        this.addParallel(new SetLiftHeightBlocking(AutoConstants.SCALE_HEIGHT,2,0.1),4);
        this.addSequential(new StraightDriveWithEncoders(AutoConstants.SPEED_CONTROLLED,-5.4,AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".endForwardToScale2"),3);
