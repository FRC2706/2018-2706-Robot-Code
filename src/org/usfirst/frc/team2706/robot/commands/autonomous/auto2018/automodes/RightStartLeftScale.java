...
public class RightStartLeftScale extends CommandGroup {
    ...
    public RightStartLeftScale() {
        ...
        // Turns down alley
        this.addSequential(new RotateDriveWithGyro(0.45,-90, AutoConstants.ROTATE_ERROR, AutoConstants.ROTATE_CYCLES,this + ".rotateToAlley"), 2);
        
        // Raise the lift all the way and drive down the alley
        this.addParallel(new SetLiftHeightBlockingAfterTime(6.9,2,0.4,2300), 6);
        this.addSequential(new StraightDriveWithEncoders2Speed(1.0,0.75, 135 / 12, 240/ 12.0,AutoConstants.ACCURATE_ERROR, AutoConstants.LENIENT_CYCLES, this + ".driveDownAlley"), 10);
